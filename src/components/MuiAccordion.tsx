...
export const MuiAccordion = () => {
    //alttaki onchange ozelligi sayesinde bi anda sadece bir accordion acilabiliyor bir digeri acilirsa digeri kapaniyor
    ...
    return (
        <div>
            <Accordion expanded={expanded === "panel1"} onChange={(event, isExpanded) => handleChange(isExpanded, "panel1")}>
                ...
                <AccordionDetails>
                    <Typography> Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati quidem, debitis, sequi eveniet quae nulla pariatur labore, est minus non exercitationem sed unde facere nostrum incidunt ipsa necessitatibus dolor totam!</Typography>
                </AccordionDetails>
            </Accordion>
            <Accordion expanded={expanded === "panel2"} onChange={(event, isExpanded) => handleChange(isExpanded, "panel2")}>
                <AccordionSummary id="pane2-header" aria-controls="panel2-content" expandIcon={<ExpandMoreIcon />}><Typography>Accordion 2</Typography></AccordionSummary>
                <AccordionDetails>
                    <Typography> Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati quidem, debitis, sequi eveniet quae nulla pariatur labore, est minus non exercitationem sed unde facere nostrum incidunt ipsa necessitatibus dolor totam!</Typography>
                </AccordionDetails>
            </Accordion>
